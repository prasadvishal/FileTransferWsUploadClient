 ...
 * generated in the com.mindfire.filetransfer package. 
...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://fileTransfer.mindfire.com/", "download");
    private final static QName _Upload_QNAME = new QName("http://fileTransfer.mindfire.com/", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://fileTransfer.mindfire.com/", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("http://fileTransfer.mindfire.com/", "uploadResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mindfire.filetransfer
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileTransfer.mindfire.com/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileTransfer.mindfire.com/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileTransfer.mindfire.com/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileTransfer.mindfire.com/", name = "uploadResponse")
